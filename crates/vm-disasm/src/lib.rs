...
use swamp_vm_types::types::{
    ...
    DecoratedOperandOrigin, FrameMemoryAttribute, FrameMemoryInfo, FramePlacedType, FunctionInfo,
    PathInfo, TypedRegister, b8_type, bytes_type, float_type, int_type, map_iter_type, map_type,
