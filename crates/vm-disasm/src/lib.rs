...
use swamp_vm_isa::{BinaryInstruction, HeapMemoryAddress, InstructionPosition, MemoryOffset, MemorySize, ProgramCounterDelta, RegIndex};
...
pub fn disasm(
    ...
    let operands_slice: &[DecoratedOperandAccessKind] = match opcode {
        ...
        OpCode::CheckU8 => &[to_read_reg(operands[0], &u8_type(), frame_memory_info)],
